...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksInHandsOfLibraryUserWithoutAnyBooks(){
        //Given
        LibraryUser user = new LibraryUser("Tomek", "Nowak", "54552");
        List<Book> resultListOf0Books = new ArrayList<Book>();
    ...
    @Test
    public void testLibraryUserWithOneBook(){
        //Given
        LibraryUser user = new LibraryUser("Tomek", "Nowak", "54552");
        List<Book> theListOf1Books = generateListOfNBooks(1);
        when(libraryDatabaseMock.listBooksInHandsOf(user)).thenReturn(theListOf1Books);
        //When
        List<Book> bookList = bookLibrary.listBooksInHandsOf(user);
        //Then
        assertEquals(1,bookList.size());
    }

    @Test
    public void testLibraryUserWithFiveBooks(){
        //Given
        LibraryUser user = new LibraryUser("Tomek", "Nowak", "54552");
